...
|----------------------------------------------------------------------------------------------------------|
| **Peng Robinson Avg Rel. Error:** -0.001, **Max rel. Error:** 0.052 <br> **DAK + Sutton & Wichert Avg Rel. Error:** 0.007, **Max rel. Error:** 0.097 <br> **DAK + PMC Avg Rel. Error:** 0.004, **Max rel. Error:** 0.157 |
