...
# Custom Tc and Pc
def tc_pc(sg_hc):
    coefic_pc = [-12.5909608560751, 670.157858769464, -0.0185837966937701]
    coefic_tc = [9.099574152165, 182.164660767474, -0.00270020030985145]
    mw_gas = mwAir * sg_hc
...
def calc_bips(hc_mw, degf):                                                                     
    ...
    #                      CO2      H2S        N2        H2 
    intcpts = np.array([0.409977, 0.273648, 0.653666, 1.20014])
    mw_slopes = np.array([-0.0000403676, -0.0017995, 0.000690878, 0.0091601])
    degR_slopes = np.array([-183.764, -77.4971, -348.227, -633.005])
    ...
    inert_bips = [0.0523249, -0.219895, -0.314059, 0.646848, 0.65, 0.36917]
